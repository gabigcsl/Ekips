        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Cargos>(entity =>
            {
                ...
                entity.HasIndex(e => e.Nome)
                    .HasName("UQ__Cargos__7D8FE3B2CF906FB1")
                    .IsUnique();
            ...
            modelBuilder.Entity<Departamento>(entity =>
            {
                ...
                entity.HasIndex(e => e.Nome)
                    .HasName("UQ__Departam__7D8FE3B2B2DF015B")
                    .IsUnique();
            ...
            modelBuilder.Entity<Funcionarios>(entity =>
            {
                ...
                entity.HasOne(d => d.IdCargoNavigation)
                    ...
                    .HasConstraintName("FK__Funcionar__IdCar__114A936A");

                entity.HasOne(d => d.IdDepartamentoNavigation)
                    .WithMany(p => p.Funcionarios)
                    .HasForeignKey(d => d.IdDepartamento)
                    .HasConstraintName("FK__Funcionar__IdDep__10566F31");

                entity.HasOne(d => d.IdUsuarioNavigation)
                    .WithMany(p => p.Funcionarios)
                    .HasForeignKey(d => d.IdUsuario)
                    .HasConstraintName("FK__Funcionar__IdUsu__123EB7A3");
            });
            ...
            modelBuilder.Entity<Permissoes>(entity =>
            {
                ...
                entity.HasIndex(e => e.Nome)
                    .HasName("UQ__Permisso__7D8FE3B238C2B960")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D105340622DE53")
                    .IsUnique();

                entity.HasIndex(e => e.Senha)
                    .HasName("UQ__Usuarios__7ABB97315C223CE1")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdPermissaoNavigation)
                    ...
                    .HasConstraintName("FK__Usuarios__IdPerm__59063A47");
            });
        }
    }
}
